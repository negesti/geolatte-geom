...
public class Positions implements Serializable {
  ...
  public static List<? extends PositionFactory> registeredFactories;
  ...
  public static <P extends Position> PositionFactory<P> getFactoryFor(Class<P> pClass) {
    for ( PositionFactory<? extends PositionFactory> pFact : registeredFactories ) {
  ...
  //Factories
  public static class CanMakeP2D implements Serializable, PositionFactory<C2D> {
  ...
  public static class CanMakeP2DM implements Serializable, PositionFactory<C2DM> {
  ...
  public static class CanMakeP3D implements Serializable, PositionFactory<C3D> {
  ...
  public static class CanMakeP3DM implements Serializable, PositionFactory<C3DM> {
  ...
  //Factories
  public static class CanMakeG2D implements Serializable, PositionFactory<G2D> {
  ...
  public static class CanMakeG2DM implements Serializable, PositionFactory<G2DM> {
  ...
  public static class CanMakeG3D implements Serializable, PositionFactory<G3D> {
  ...
  public static class CanMakeG3DM implements Serializable, PositionFactory<G3DM> {
